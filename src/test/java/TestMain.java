...
public class TestMain {
    ...
    @DataProvider(name = "DecimalBinaryProviderFailed", parallel = true)
    ...
    @DataProvider(name = "BinaryToOctalProviderFailed", parallel = true)
    ...
    @DataProvider(name = "validateNumberProviderFailed", parallel = true)
